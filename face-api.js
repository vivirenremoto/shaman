    ...
    function drawFaceExpressions(canvasArg, faceExpressions, minConfidence, textFieldAnchor) {
        ...
        faceExpressionsArray.forEach(function (e) {
            ...
            var drawTextField = new DrawTextField(resultsToDisplay.map(function (expr) { 
                ...
                if( expr.expression == 'surprised' || expr.expression == 'sad' || expr.expression == 'angry' || expr.expression == 'neutral' ){

                    if(!printed) {
                        printed = true;
                        
                        if( expr.expression != prev_expression ){
                        prev_expression = expr.expression;
                        console.log(expr.expression + " - " + expr.probability);
                            ...
                            if( unityInstance != null ){
                                ...
                                if(expr.expression != 'neutral' ){
                                    console.log("enter");
                                    unityInstance.SendMessage('PlayerController', 'UpdateStatus', expr.expression);
                                } 
                            }
                        }
                    }
